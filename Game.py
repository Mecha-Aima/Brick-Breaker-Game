...
class Game:
    def __init__(self, level, score):
       # Initialize the game with level and score as arguments
        self.level = level
        self.score = score
        self.lives = 3 if level < 3 else 2  # Default starting lives
        self.speed = 10  # Default pad speed
    ...
    def setup_pygame(self):
        ...
        self.small_text = pygame.font.Font(None, 36)
    ...
    # Game Loop
    def run(self):
        if not self.main_menu(self.Menu_background):
            self.game_over = True
        ...
        while not self.game_over:
            ...
            elif Key_press[pygame.K_LEFT]and self.game_start:
            ...
            #Check win
            if not 0 in self.countCollision:
            ...
            if self.lives==0:
                self.game_over=True
                if self.display_game_over(self.Game_OV_BG) or self.main_menu(self.Menu_background): # Returns true for game restart
                    self.game_over=False
                    self.game_start=False
                    return "restart"
